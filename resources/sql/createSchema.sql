...
CREATE TABLE "STATION_BUS" (
  ...
  CONSTRAINT STATION_ID_BUS_ID_FK FOREIGN KEY ("STATION_ID") REFERENCES "BUS" ("ID") ON DELETE CASCADE ENABLE,
  CONSTRAINT BUS_ID_STATION_ID_FK FOREIGN KEY ("BUS_ID") REFERENCES "STATION" ("ID") ON DELETE CASCADE ENABLE
)
/